...
export const site = {
  ...
  photo: "/headshot.jpg",
  // Generated by `npm run resume` from the data below. No phone number in it —
  // anything in public/ is world-readable, so the number stays off the web.
  resume: "/RohitJain-Resume.pdf",
  url: "https://rohitjain.is-a.dev",
};

/** Social rail — rendered as icon links in the masthead and the footer. */
export const socials = [
  { label: "GitHub", handle: "@jrohit", href: site.github, icon: "github" as const },
  { label: "LinkedIn", handle: "connectwithrohit", href: site.linkedin, icon: "linkedin" as const },
  { label: "Email", handle: site.email, href: `mailto:${site.email}`, icon: "mail" as const },
...
/**
 * ---------------------------------------------------------------------------
 * RÉSUMÉ — the source of truth for /resume and for the generated PDF.
 * Deliberately no phone number: `npm run resume` writes the PDF straight into
 * public/, which is world-readable, so the number never gets published.
 * Reach me by email; I'll share a number once we're actually talking.
 * ---------------------------------------------------------------------------
 */
export const resume = {
  summary:
    "Engineering Manager and principal-level frontend engineer with 15+ years architecting, scaling and modernising large customer-facing platforms across SaaS, cybersecurity and enterprise. Leads a cross-geography team of seven while owning the architecture hands-on. AI-first in practice: LLMs in the product, in the engineering workflow, and in a production media pipeline built and operated end to end.",
  roles: [
    {
      role: "Engineering Manager — Frontend",
      company: "HivePro Inc.",
      ...
      place: "Remote / Pune, India",
      points: [
        "Lead, mentor and grow a team of 7 engineers across three time zones — hiring, performance reviews, career growth and roadmap planning.",
        "Led an end-to-end re-architecture that cut page load time by ~63% and lifted Core Web Vitals, accessibility and developer velocity with it.",
        "Drove AI adoption across the engineering workflow — coding assistants and automation in development, testing and documentation, with measurable onboarding gains.",
        "Established code-review standards, CI/CD pipelines and frontend testing practice (Jest, React Testing Library) that cut regression rates.",
        "Escalation point for high-risk changes and production incidents; own the post-incident review.",
      ],
    },
    {
      role: "Senior Software Engineer",
      ...
      points: [
        "Designed customer-facing web applications with React, Node.js and GraphQL for a large SaaS-style platform.",
        "Implemented monorepo and micro-frontend architecture, enabling independent team ownership and decoupled, safely reversible deployments.",
        "Contributed to AWS deployments (EC2, S3, CloudFront) and CI/CD, focused on rollback safety and observability.",
      ],
    },
    {
      role: "UI Engineer / Senior Frontend Developer",
      ...
      points: [
        "Delivered large-scale customer-facing and internal enterprise applications in React, Angular, Backbone.js and Marionette.js.",
        "Led modernisation of legacy Backbone/Marionette applications onto React, reducing technical debt and improving performance.",
        "Drove adoption of TypeScript and shared component libraries across teams for type safety and UI consistency.",
      ],
    },
    {
      role: "Senior Software Engineer",
      ...
      place: "Pune, India",
      points: [
        "Built greenfield applications for UK Government projects, partnering on REST API design, compliance and accessibility.",
      ],
    },
    {
      role: "Senior Software Engineer",
      ...
      place: "Indore, India",
      points: [
        "Worked across frontend and backend — database modelling, Java REST APIs and UI development; mentored junior engineers.",
      ],
    },
    {
      role: "Senior Web Developer",
      ...
      place: "Indore, India",
      points: [
        "Delivered client applications in Java/Struts — schema design, backend APIs and unit testing.",
      ],
    },
  ],
  projects: [
    {
      ...
      href: "https://thepulsenews.in",
      detail:
        "Production content pipeline — Gemini for scripting and quality scoring, ElevenLabs for voice, Remotion for programmatic rendering, orchestrated in n8n on Docker with Cloudflare R2. Scheduled, multi-language, with fail-closed content gates and batch resilience.",
    },
    {
      name: "Proxmox home lab",
      href: "https://mylocalcloud.in",
      detail:
        "Multi-VM Proxmox lab running self-hosted services, exposed through Cloudflare Tunnels with no open ports. Designed, built and operated solo.",
    },
    {
      name: "EquiSplit",
      href: "https://equisplit.mylocalcloud.in",
      detail:
        "Splitwise-style expense-sharing platform with web and Android clients on Node.js and MongoDB — push notifications, async event handling and offline conflict resolution.",
    },
  ],
};
